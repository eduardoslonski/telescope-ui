...
export const SYSTEM_METRIC_INFO: Record<string, { label: string; unit: string }> = {
  ...
  generation_tokens_total: { label: "Generation Tokens Total", unit: "" },
  ...
  queue_time_mean: { label: "Queue Time (Mean)", unit: "s" },
  inference_time_mean: { label: "Inference Time (Mean)", unit: "s" },
  prefill_time_mean: { label: "Prefill Time (Mean)", unit: "s" },
  decode_time_mean: { label: "Decode Time (Mean)", unit: "s" },
  iteration_tokens_mean: { label: "Iteration Tokens (Mean)", unit: "" },
  generation_tokens_per_request_mean: { label: "Generation Tokens/Request (Mean)", unit: "" },
  prompt_tokens_per_request_mean: { label: "Prompt Tokens/Request (Mean)", unit: "" },
}
